const ctsNames = ['A','B','C','D']; //["Respect", "Courage", "Charisma", "Force"];
...
function Card() {
	...
	this.getDivId = function(){ return "card"+this.nb; };
	this.getDiv = function() {
		let div = document.getElementById(this.getDivId()) || document.createElement('div');
...
<tr class="cts">
	<td>Base: ${this.base}</td>
	<td>
		<p class="pts">${(this.totalPts/(100*this.parties||1))|0} (${this.parties})</p>
		<p class="currPts">${(this.pts/100)|0} (${this.parties})</p>
	</td>
</tr>`;
...
<tr class="cts">
	...
	<td>-</td>
		...
		div.innerHTML = content + '<tr class="effect"><td colspan="2">' + this.effect.toString() + "</td></tr></table>";
